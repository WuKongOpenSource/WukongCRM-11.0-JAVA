/*
 ...
 Source Schema         : wk_hrm_single

 Target Server Type    : MySQL
 Target Server Version : 50720
 File Encoding         : 65001

 Date: 24/09/2020 14:06:40
*/
...
CREATE TABLE `wk_hrm_achievement_appraisal`  (
  ...
  `cycle_type` int(1) NULL DEFAULT NULL COMMENT '1 月 2 季 3 年 4 半年',
  `start_time` date NULL DEFAULT NULL COMMENT '考核开始时间',
  `end_time` date NULL DEFAULT NULL COMMENT '考核结束时间',
  `table_id` int(20) NULL DEFAULT NULL COMMENT '考核表模板id',
  `written_by` int(1) NULL DEFAULT 1 COMMENT '考核目标填写人 1 本人',
  ...
  `is_force` int(1) NULL DEFAULT NULL COMMENT '是否开启强制分布 1 是 0 否',
  ...
  `status` int(1) NULL DEFAULT 0 COMMENT '绩效状态 0 未开启考核 1 绩效填写中 2 绩效评定中 3 结果确认中 4 归档',
  `is_stop` int(1) NULL DEFAULT 0 COMMENT '是否终止 0 否 1 是',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '绩效考核' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_achievement_appraisal_evaluators`  (
  ...
  `type` int(1) NOT NULL COMMENT '1 员工本人 2 直属上级 3 所在部门负责人 4 上级部门负责人 5 指定目标确认人',
  `employee_id` int(11) NULL DEFAULT NULL COMMENT '指定确认人id',
  `weight` decimal(5, 2) NOT NULL COMMENT '权重',
  `sort` int(4) NULL DEFAULT NULL,
  PRIMARY KEY (`evaluators_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '考核结果评定人' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_achievement_appraisal_score_level`  (
  ...
  `min_num` int(4) NOT NULL COMMENT '最小人数比例',
  `max_num` int(4) NOT NULL COMMENT '最大人数比例',
  `sort` int(4) NULL DEFAULT NULL,
  PRIMARY KEY (`level_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '考评规则等级' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_achievement_appraisal_target_confirmors`  (
  ...
  `appraisal_id` int(11) NULL DEFAULT NULL COMMENT '考核id',
  `type` int(1) NULL DEFAULT NULL COMMENT '1 员工本人 2 直属上级 3 所在部门负责人 4 上级部门负责人 5 指定目标确认人',
  `employee_id` int(11) NULL DEFAULT NULL COMMENT '指定确认人id',
  `sort` int(4) NULL DEFAULT NULL COMMENT '步骤号 从小到大',
  PRIMARY KEY (`target_confirmors_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '考核目标确认人' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_achievement_employee_appraisal`  (
  ...
  `appraisal_id` int(11) NULL DEFAULT NULL COMMENT '绩效id',
  `status` int(2) NULL DEFAULT NULL COMMENT '考核状态 1 待填写 2 待目标确认 3 待评定 4 待结果确认 5 终止绩效 6 考核完成',
  `score` double(10, 2) NULL DEFAULT NULL COMMENT '评分',
  `level_id` int(11) NULL DEFAULT NULL COMMENT '考核结果',
  `read_status` int(2) NULL DEFAULT 0 COMMENT '结果阅读状态 0 未读 1 已读',
  `follow_up_employee_id` int(11) NULL DEFAULT NULL COMMENT '跟进员工id',
  `follow_sort` int(2) NULL DEFAULT NULL COMMENT '跟进员工排序',
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`employee_appraisal_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工绩效考核' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_achievement_employee_evaluato`  (
  ...
  `employee_appraisal_id` int(11) NULL DEFAULT NULL COMMENT '员工端考核id',
  `appraisal_id` int(11) NULL DEFAULT NULL COMMENT '绩效id',
  ...
  `level_id` int(11) NULL DEFAULT NULL COMMENT '考核等级',
  ...
  `status` int(1) NULL DEFAULT 0 COMMENT '0 待评定 1 已评定',
...
CREATE TABLE `wk_hrm_achievement_employee_evaluato_seg`  (
  ...
  `employee_appraisal_id` int(11) NULL DEFAULT NULL COMMENT '员工端考核id',
  `employee_evaluato_id` int(11) NULL DEFAULT NULL COMMENT '结果评定id',
  `seg_id` int(11) NULL DEFAULT NULL COMMENT '考核项id',
  `employee_id` int(11) NOT NULL COMMENT '评定人',
  `score` decimal(7, 2) NULL DEFAULT NULL COMMENT '评分',
  `evaluate` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '评语',
  `status` int(2) NULL DEFAULT 1 COMMENT '0 待评定 1 已评定',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `wk_hrm_achievement_employee_result_confirmors`  (
  ...
  `appraisal_id` int(11) NULL DEFAULT NULL COMMENT '绩效id',
  `status` int(2) NULL DEFAULT 0 COMMENT '0 未确认 1 已确认',
  `sort` int(2) NULL DEFAULT NULL,
...
CREATE TABLE `wk_hrm_achievement_employee_seg`  (
  ...
  `employee_appraisal_id` int(11) NULL DEFAULT NULL,
  `temp_seg_id` int(11) NULL DEFAULT 0 COMMENT '模板考核项id',
  `employee_id` int(11) NULL DEFAULT NULL,
  ...
  `is_fixed` int(1) NULL DEFAULT NULL COMMENT '是否固定 1 是 0 否',
  `weight` decimal(5, 2) NULL DEFAULT NULL COMMENT '权重 -1 员工写权重比 0~100',
  `schedule` int(4) NULL DEFAULT 0 COMMENT '目标进度',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工绩效考核项' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_achievement_employee_seg_item`  (
  ...
  `temp_item_id` int(11) NULL DEFAULT 0 COMMENT '模板考核项id',
  `item_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '选项名称',
  `value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '值',
  `sort` int(2) NULL DEFAULT NULL,
  PRIMARY KEY (`item_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工考核项选项' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_achievement_employee_target_confirm`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL,
  `sort` int(2) NULL DEFAULT NULL,
  `status` int(1) NULL DEFAULT 0 COMMENT '0 待确认 1 已确认 2 驳回 ',
...
CREATE TABLE `wk_hrm_achievement_table`  (
  ...
  `type` int(1) NULL DEFAULT NULL COMMENT '1 OKR模板 2 KPI模板',
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '考核表描述',
  `is_emp_weight` int(2) NULL DEFAULT 0 COMMENT '是否员工填写权重 0 否 1 是',
  `status` int(1) NULL DEFAULT 1 COMMENT ' 1 使用 0 删除',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `create_user_id` bigint(20) NULL DEFAULT NULL,
...
CREATE TABLE `wk_hrm_action_record`  (
  ...
  `type` int(2) NULL DEFAULT NULL COMMENT '操作类型 1 员工 2 招聘管理 3 候选人 4 绩效管理',
  `type_id` int(11) NULL DEFAULT NULL COMMENT '操作对象id',
  `behavior` int(2) NULL DEFAULT NULL COMMENT '操作行为 1 新建 2 编辑 3 删除 4 转正 5 调岗 6 晋升 7 降级 8 转全职员工 9 离职 10 参保方案',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容',
  `create_user_id` bigint(20) NOT NULL COMMENT '操作人ID',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `types`(`type`, `type_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'hrm员工操作记录表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for wk_hrm_attendance
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance`;
CREATE TABLE `wk_hrm_attendance`  (
  `attendance_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '考勤组id',
  `attendance_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '考勤组名称',
  `status` int(4) NOT NULL DEFAULT 1 COMMENT '状态 1使用中 2删除',
  `create_user_id` int(11) NOT NULL COMMENT '创建人id',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `monday` int(11) NOT NULL COMMENT '星期一班次',
  `tuesday` int(11) NOT NULL COMMENT '星期二班次',
  `wednesday` int(11) NOT NULL COMMENT '星期三班次',
  `thursday` int(11) NOT NULL COMMENT '星期四班次',
  `friday` int(11) NOT NULL COMMENT '星期五班次',
  `saturday` int(11) NOT NULL COMMENT '星期六班次',
  `sunday` int(11) NOT NULL COMMENT '星期日班次',
  `is_show` int(11) NULL DEFAULT 1 COMMENT '0 不展示 1 展示',
  `apply_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '适用部门id -1为全公司',
  PRIMARY KEY (`attendance_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '考勤组表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance
-- ----------------------------
...
CREATE TABLE `wk_hrm_attendance_clock`  (
  ...
  `clock_user_id` int(11) NULL DEFAULT NULL COMMENT '打卡人',
  `clock_time` datetime(0) NULL DEFAULT NULL COMMENT '打卡时间',
  `shift_time` datetime(0) NULL DEFAULT NULL COMMENT '对应上下班时间',
  `status` int(4) NOT NULL COMMENT '打卡情况 0预生成记录 1正常 2迟到 3早退 4缺卡 5 旷工 6 休息',
  `sort` int(4) NULL DEFAULT NULL COMMENT '当天打卡次数',
  `type` int(4) NULL DEFAULT NULL COMMENT '打卡类型 1手机端打卡 2手工录入',
  ...
  `update_user_id` int(11) NULL DEFAULT NULL COMMENT '操作人id',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`clock_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '打卡记录表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for wk_hrm_attendance_clock_type
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance_clock_type`;
CREATE TABLE `wk_hrm_attendance_clock_type`  (
  `clock_type_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '打卡方式id',
  `type` int(4) NOT NULL COMMENT '打卡类型 1地址 2wifi',
  `status` int(4) NOT NULL DEFAULT 1 COMMENT '状态 1使用中 2删除',
  `clock_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '地址名称或wifi名称',
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '详细地址',
  `lng` decimal(10, 8) NULL DEFAULT NULL COMMENT '经度',
  `lat` decimal(10, 8) NULL DEFAULT NULL COMMENT '维度',
  `scope` int(4) NULL DEFAULT NULL COMMENT '打卡范围',
  `wifi_mac` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'mac地址',
  `is_show` int(4) NOT NULL DEFAULT 1 COMMENT '0不展示 1展示',
  PRIMARY KEY (`clock_type_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '打卡方式表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance_clock_type
-- ----------------------------

-- ----------------------------
-- Table structure for wk_hrm_attendance_clock_type_relation
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance_clock_type_relation`;
CREATE TABLE `wk_hrm_attendance_clock_type_relation`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `attendance_id` int(11) NOT NULL COMMENT '考勤组id',
  `clock_type_id` int(11) NOT NULL COMMENT '打卡方式id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '考勤组和打卡方式关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance_clock_type_relation
-- ----------------------------

-- ----------------------------
-- Table structure for wk_hrm_attendance_go_out
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance_go_out`;
CREATE TABLE `wk_hrm_attendance_go_out`  (
  `out_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '用户id',
  `customer_id` int(11) NOT NULL COMMENT '客户id',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '内容',
  `address` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '打卡地点',
  `lng` decimal(10, 8) NULL DEFAULT NULL COMMENT '经度',
  `lat` decimal(10, 8) NULL DEFAULT NULL COMMENT '维度',
  `batch_id` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '文件集合id',
  `go_out_time` datetime(0) NOT NULL COMMENT '出勤时间',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`out_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '外勤信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance_go_out
-- ----------------------------

-- ----------------------------
-- Table structure for wk_hrm_attendance_record
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance_record`;
CREATE TABLE `wk_hrm_attendance_record`  (
  `record_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '考勤组变更记录id',
  `type` int(4) NOT NULL COMMENT '记录类型 1用户变更考勤组 2考勤组更新 3班次更新 4打卡方式更新',
  `id` int(11) NULL DEFAULT NULL COMMENT '对象id',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `before_id` int(11) NULL DEFAULT NULL COMMENT '变更前id',
  `after_id` int(11) NULL DEFAULT NULL COMMENT '变更后id',
  PRIMARY KEY (`record_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户考勤组变更记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance_record
-- ----------------------------

-- ----------------------------
-- Table structure for wk_hrm_attendance_report
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance_report`;
CREATE TABLE `wk_hrm_attendance_report`  (
  `report_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '报表id',
  `user_id` int(11) NOT NULL COMMENT '用户id',
  `day` date NOT NULL COMMENT '日期',
  `plan_days` int(2) NOT NULL DEFAULT 0 COMMENT '应出勤天数 1 应出勤 0 休息',
  `real_days` int(2) NOT NULL DEFAULT 0 COMMENT '实际出勤天数 1 出勤 0 未出勤',
  `late_count` int(2) NOT NULL DEFAULT 0 COMMENT '迟到次数',
  `leave_early_count` int(2) NOT NULL DEFAULT 0 COMMENT '早退次数',
  `absent_count` int(2) NOT NULL DEFAULT 0 COMMENT '矿工次数',
  `lack_card_count` int(2) NOT NULL DEFAULT 0 COMMENT '缺卡次数',
  PRIMARY KEY (`report_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '考勤报表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance_report
-- ----------------------------
...
CREATE TABLE `wk_hrm_attendance_shift`  (
  `shift_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '班次id',
  `shift_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '班次名字',
  `shift_time` int(4) NOT NULL COMMENT '考勤时长',
  `shift_count` int(2) NOT NULL DEFAULT 0 COMMENT '当天应打卡次数',
  `status` int(4) NOT NULL DEFAULT 0 COMMENT '状态 1使用中 2删除',
  `create_user_id` int(11) NOT NULL COMMENT '创建人id',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `is_show` int(4) NOT NULL DEFAULT 1 COMMENT '0不展示 1展示',
  PRIMARY KEY (`shift_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '班次表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for wk_hrm_attendance_shift_time
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance_shift_time`;
CREATE TABLE `wk_hrm_attendance_shift_time`  (
  `time_id` int(11) NOT NULL AUTO_INCREMENT,
  `shift_id` int(11) NOT NULL COMMENT '班次id',
  `time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '班次时间',
  `sort` int(4) NOT NULL COMMENT '当天打卡顺序',
  PRIMARY KEY (`time_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '班次时间表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance_shift_time
-- ----------------------------

-- ----------------------------
-- Table structure for wk_hrm_attendance_special_date
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_attendance_special_date`;
CREATE TABLE `wk_hrm_attendance_special_date`  (
  `special_date_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '特殊日期id',
  `attendance_id` int(11) NOT NULL COMMENT '考勤组id',
  `special_date` date NOT NULL COMMENT '特殊日期',
  `shift_id` int(11) NOT NULL COMMENT '班次',
  PRIMARY KEY (`special_date_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '特殊日期设置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_attendance_special_date
-- ----------------------------
...
CREATE TABLE `wk_hrm_config`  (
  ...
  `type` int(2) NULL DEFAULT NULL COMMENT '配置类型 1 淘汰原因 2 薪资初始化配置1 3 薪资初始化配置2 4 社保初始化配置1 5 社保初始化配置2',
  `value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '值',
  `create_time` datetime(0) NULL DEFAULT NULL,
...
INSERT INTO `wk_hrm_config` VALUES (147, 4, '1', '2020-06-09 14:38:43');
INSERT INTO `wk_hrm_config` VALUES (148, 5, '1', '2020-06-09 14:38:43');
...
CREATE TABLE `wk_hrm_dept`  (
  ...
  `dept_type` int(1) NULL DEFAULT NULL COMMENT '1 公司 2 部门',
  ...
  `main_employee_id` int(11) NULL DEFAULT NULL COMMENT '部门负责人ID',
  `leader_employee_id` int(11) NULL DEFAULT NULL COMMENT '分管领导',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `create_user_id` bigint(20) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `wk_hrm_dept` VALUES (18, 0, 1, '全公司', '1', NULL, NULL, NULL, 14773);
...
CREATE TABLE `wk_hrm_employee`  (
  ...
  `id_type` int(1) NULL DEFAULT NULL COMMENT '证件类型 1 身份证 2 港澳通行证 3 台湾通行证 4 护照 5 其他',
  `id_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '证件号码',
  `sex` int(4) NULL DEFAULT NULL COMMENT '性别 1 男 2 女',
  ...
  `birthday_type` int(1) NULL DEFAULT 1 COMMENT '生日类型 1 阳历 2 农历',
  ...
  `highest_education` int(1) NULL DEFAULT NULL COMMENT '最高学历',
  `entry_time` datetime(0) NULL DEFAULT NULL COMMENT '入职时间',
  `probation` int(2) NULL DEFAULT NULL COMMENT '试用期 0 无试用期',
  ...
  `parent_id` int(11) NULL DEFAULT NULL COMMENT '直属上级ID',
  ...
  `channel_id` int(11) NULL DEFAULT NULL COMMENT '招聘渠道',
  `employment_forms` int(1) NULL DEFAULT NULL COMMENT '聘用形式 1 正式 2 非正式',
  `status` int(2) NULL DEFAULT NULL COMMENT '员工状态 1正式 2试用  3实习 4兼职 5劳务 6顾问 7返聘 8外包',
  `company_age_start_time` datetime(0) NULL DEFAULT NULL COMMENT '司龄开始日期',
  `company_age` int(6) NULL DEFAULT 0 COMMENT '司龄',
  `entry_status` int(2) NULL DEFAULT NULL COMMENT '入职状态 1 在职 2 待入职 3 待离职 4 离职',
  `candidate_id` int(11) NULL DEFAULT NULL COMMENT '候选人id',
  `is_del` int(1) NULL DEFAULT 0 COMMENT '0 未删除 1 删除',
  `create_user_id` bigint(20) NOT NULL COMMENT '创建人id',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`employee_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_employee_abnormal_change_record`  (
  ...
  `type` int(2) NULL DEFAULT NULL COMMENT '异动类型 1 新入职 2 离职 3 转正 4 调岗',
  `employee_id` int(11) NULL DEFAULT NULL COMMENT '异动员工id',
  `change_time` datetime(0) NULL DEFAULT NULL COMMENT '异动时间',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`change_record_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工异常表动记录表（薪资列表统计需要）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '员工证书' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_employee_change_record`  (
  ...
  `employee_id` int(11) NULL DEFAULT NULL COMMENT '员工id',
  `change_type` int(1) NULL DEFAULT NULL COMMENT '变动类型 4 转正 5调岗 6晋升 7降级 8转为全职员工',
  `change_reason` int(1) NULL DEFAULT NULL COMMENT '异动原因 1 组织架构调整 2个人申请 3 工作安排 4 违规违纪 5 绩效不达标 6 个人身体原因 7 不适应当前岗位',
  `old_dept` int(11) NULL DEFAULT NULL COMMENT '原部门',
  `new_dept` int(11) NULL DEFAULT NULL COMMENT '新部门',
  ...
  `old_parent_id` int(11) NULL DEFAULT NULL COMMENT '原直属上级',
  `new_parent_id` int(11) NULL DEFAULT NULL COMMENT '新直属上级',
  `probation` int(2) NULL DEFAULT NULL COMMENT '试用期',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '员工联系人' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_employee_contacts_data`  (
  ...
  `label_group` int(2) NULL DEFAULT NULL,
...
CREATE TABLE `wk_hrm_employee_contract`  (
  ...
  `contract_type` int(1) NULL DEFAULT NULL COMMENT '1、固定期限劳动合同 2、无固定期限劳动合同 3、已完成一定工作任务为期限的劳动合同 4、实习协议 5、劳务合同 6、返聘协议 7、劳务派遣合同 8、借调合同 9、其他',
  `start_time` datetime(0) NULL DEFAULT NULL,
  `end_time` datetime(0) NULL DEFAULT NULL,
  `term` int(2) NULL DEFAULT NULL COMMENT '期限',
  `status` int(2) NULL DEFAULT NULL COMMENT '合同状态  0未执行 1 执行中、 2已到期、 ',
  ...
  `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '备注',
  `is_expire_remind` int(1) NULL DEFAULT NULL COMMENT '是否到期提醒 0 否 1 是',
  `sort` int(2) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `create_user_id` bigint(20) NULL DEFAULT NULL,
  `batch_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  PRIMARY KEY (`contract_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '员工合同' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_employee_data`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '客户扩展字段数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_employee_education_experience`  (
  ...
  `employee_id` int(11) NULL DEFAULT NULL,
  `education` int(2) NULL DEFAULT NULL COMMENT '学历 1小学、2初中、3中专、4中职、5中技、6高中、7大专、8本科、9硕士、10博士、11博士后、12其他',
  ...
  `teaching_methods` int(2) NULL DEFAULT NULL COMMENT '教学方式 1 全日制、2成人教育、3远程教育、4自学考试、5其他',
  `is_first_degree` int(1) NULL DEFAULT NULL COMMENT '是否第一学历 0 否 1 是',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `sort` int(2) NULL DEFAULT NULL,
  PRIMARY KEY (`education_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '员工教育经历' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_employee_field`  (
  ...
  `type` int(2) NOT NULL DEFAULT 1 COMMENT '字段类型 1 单行文本 2 多行文本 3 单选 4日期 5 数字 6 小数 7 手机  8 文件 9 多选   10 日期时间 11 邮箱 12 籍贯地区',
  `component_type` int(2) NOT NULL DEFAULT 1 COMMENT '关联表类型 0 不需要关联 1 hrm员工 2 hrm部门 3 hrm职位 4 系统用户 5 系统部门 6 招聘渠道',
  `label` int(2) NULL DEFAULT NULL COMMENT '标签 1 个人信息 2 岗位信息 3 合同 4 工资社保',
  `label_group` int(2) NOT NULL COMMENT '标签分组 * 1 员工个人信息 2 通讯信息 3 教育经历 4 工作经历 5 证书/证件 6 培训经历 7 联系人\n        * 11 岗位信息 12 离职信息 \n        * 21 合同信息 \n        * 31 工资卡信息 32 社保信息',
  ...
  `is_fixed` int(1) NOT NULL DEFAULT 0 COMMENT '是否固定字段 0 否 1 是',
  ...
  `is_update_value` int(1) NULL DEFAULT 1 COMMENT '是否可以修改值 0 否 1 是',
  `is_head_field` int(1) NULL DEFAULT 0 COMMENT '是否在列表头展示 0 否 1 是',
  `is_import_field` int(1) NULL DEFAULT 0 COMMENT '是否需要导入字段 0 否 1 是',
...
-- ----------------------------
INSERT INTO `wk_hrm_employee_field` VALUES (1103, 'employee_name', '姓名', 1, 0, 1, 1, '', '', 50, '', 0, 1, 1, '', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1104, '英文名', '英文名', 1, 1, 1, 1, '', '', 50, '', 0, 0, 2, '', 0, '111111', 0, 1, 0, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1105, 'mobile', '手机', 7, 0, 1, 1, '', '11位手机号', 11, '', 1, 1, 3, '', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1106, 'id_type', '证件类型', 3, 0, 1, 1, '', '', 1, '', 0, 0, 4, '[{\"name\":\"身份证\",\"value\":1},{\"name\":\"港澳通行证\",\"value\":2},{\"name\":\"台湾通行证\",\"value\":3},{\"name\":\"护照\",\"value\":4},{\"name\":\"其他\",\"value\":5}]', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1107, 'id_number', '证件号码', 1, 0, 1, 1, '', '', 255, '', 0, 0, 5, '', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1108, 'sex', '性别', 3, 0, 1, 1, '', '', 1, '', 0, 0, 6, '[{\"name\":\"男\",\"value\":1},{\"name\":\"女\",\"value\":2}]', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1109, 'date_of_birth', '出生日期', 4, 0, 1, 1, '', '', 1, '', 0, 0, 7, '', 1, '000000', 0, 0, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1110, 'birthday_type', '生日类型', 3, 0, 1, 1, '', '', 50, '', 0, 0, 8, '[{\"name\":\"阳历\",\"value\":1},{\"name\":\"农历\",\"value\":2}]', 1, '000000', 0, 1, 0, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1111, 'birthday', '生日', 1, 0, 1, 1, '', '示例 : 0323', 50, '', 0, 0, 9, '', 1, '001110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1112, 'age', '年龄', 5, 0, 1, 1, '', '', 50, '', 0, 0, 10, '', 1, '000000', 0, 0, 1, 0, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1113, '是否已婚', '是否已婚', 3, 0, 1, 1, '', '', 50, '', 0, 0, 11, '[{\"name\":\"是\",\"value\":\"是\"},{\"name\":\"否\",\"value\":\"否\"}]', 0, '111110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1114, '是否已育', '是否已育', 3, 0, 1, 1, '', '', 50, '', 0, 0, 12, '[{\"name\":\"是\",\"value\":\"是\"},{\"name\":\"否\",\"value\":\"否\"}]', 0, '111110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1115, 'country', '国家地区', 3, 0, 1, 1, '', '', 50, '', 0, 0, 13, '[{\"name\":\"中国\",\"value\":\"中国\"},{\"name\":\"中国香港\",\"value\":\"中国香港\"},{\"name\":\"中国澳门\",\"value\":\"中国澳门\"},{\"name\":\"中国台湾\",\"value\":\"中国台湾\"}]', 1, '001110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1116, 'nation', '民族', 3, 0, 1, 1, '', '', 50, '', 0, 0, 14, '[{\"name\":\"汉族\",\"value\":\"汉族\"},{\"name\":\"满族\",\"value\":\"满族\"},{\"name\":\"蒙古族\",\"value\":\"蒙古族\"},{\"name\":\"回族\",\"value\":\"回族\"},{\"name\":\"藏族\",\"value\":\"藏族\"},{\"name\":\"维吾尔族\",\"value\":\"维吾尔族\"},{\"name\":\"苗族\",\"value\":\"苗族\"},{\"name\":\"彝族\",\"value\":\"彝族\"},{\"name\":\"壮族\",\"value\":\"壮族\"},{\"name\":\"布依族\",\"value\":\"布依族\"},{\"name\":\"侗族\",\"value\":\"侗族\"},{\"name\":\"瑶族\",\"value\":\"瑶族\"},{\"name\":\"白族\",\"value\":\"白族\"},{\"name\":\"土家族\",\"value\":\"土家族\"},{\"name\":\"哈尼族\",\"value\":\"哈尼族\"},{\"name\":\"哈萨克族\",\"value\":\"哈萨克族\"},{\"name\":\"傣族\",\"value\":\"傣族\"},{\"name\":\"黎族\",\"value\":\"黎族\"},{\"name\":\"傈僳族\",\"value\":\"傈僳族\"},{\"name\":\"佤族\",\"value\":\"佤族\"},{\"name\":\"畲族\",\"value\":\"畲族\"},{\"name\":\"高山族\",\"value\":\"高山族\"},{\"name\":\"拉祜族\",\"value\":\"拉祜族\"},{\"name\":\"水族\",\"value\":\"水族\"},{\"name\":\"东乡族\",\"value\":\"东乡族\"},{\"name\":\"纳西族\",\"value\":\"纳西族\"},{\"name\":\"景颇族\",\"value\":\"景颇族\"},{\"name\":\"柯尔克孜族\",\"value\":\"柯尔克孜族\"},{\"name\":\"土族\",\"value\":\"土族\"},{\"name\":\"达斡尔族\",\"value\":\"达斡尔族\"},{\"name\":\"仫佬族\",\"value\":\"仫佬族\"},{\"name\":\"羌族\",\"value\":\"羌族\"},{\"name\":\"布朗族\",\"value\":\"布朗族\"},{\"name\":\"撒拉族\",\"value\":\"撒拉族\"},{\"name\":\"毛南族\",\"value\":\"毛南族\"},{\"name\":\"仡佬族\",\"value\":\"仡佬族\"},{\"name\":\"锡伯族\",\"value\":\"锡伯族\"},{\"name\":\"阿昌族\",\"value\":\"阿昌族\"},{\"name\":\"普米族\",\"value\":\"普米族\"},{\"name\":\"朝鲜族\",\"value\":\"朝鲜族\"},{\"name\":\"塔吉克族\",\"value\":\"塔吉克族\"},{\"name\":\"怒族\",\"value\":\"怒族\"},{\"name\":\"乌孜别克族\",\"value\":\"乌孜别克族\"},{\"name\":\"俄罗斯族\",\"value\":\"俄罗斯族\"},{\"name\":\"鄂温克族\",\"value\":\"鄂温克族\"},{\"name\":\"德昂族\",\"value\":\"德昂族\"},{\"name\":\"保安族\",\"value\":\"保安族\"},{\"name\":\"裕固族\",\"value\":\"裕固族\"},{\"name\":\"京族\",\"value\":\"京族\"},{\"name\":\"塔塔尔族\",\"value\":\"塔塔尔族\"},{\"name\":\"独龙族\",\"value\":\"独龙族\"},{\"name\":\"鄂伦春族\",\"value\":\"鄂伦春族\"},{\"name\":\"赫哲族\",\"value\":\"赫哲族\"},{\"name\":\"门巴族\",\"value\":\"门巴族\"},{\"name\":\"珞巴族\",\"value\":\"珞巴族\"},{\"name\":\"基诺族\",\"value\":\"基诺族\"}]', 1, '001110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1117, '政治面貌', '政治面貌', 1, 0, 1, 1, '', '', 50, '', 0, 0, 15, '', 0, '001110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1118, 'native_place', '籍贯', 3, 7, 1, 1, '', '', 50, '', 0, 0, 16, '', 1, '001110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1119, 'address', '户籍所在地', 1, 0, 1, 1, '', '', 255, '', 0, 0, 17, '', 1, '101110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1120, '健康状态', '健康状态', 1, 0, 1, 1, '', '', 255, '', 0, 0, 18, '', 0, '101111', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1121, 'highest_education', '最高学历', 3, 0, 1, 1, '', '', 50, '', 0, 0, 19, '[{\"name\":\"小学\",\"value\":1},{\"name\":\"初中\",\"value\":2},{\"name\":\"中专\",\"value\":3},{\"name\":\"中职\",\"value\":4},{\"name\":\"中技\",\"value\":5},{\"name\":\"高中\",\"value\":6},{\"name\":\"大专\",\"value\":7},{\"name\":\"本科\",\"value\":8},{\"name\":\"硕士\",\"value\":9},{\"name\":\"博士\",\"value\":10},{\"name\":\"博士后\",\"value\":11},{\"name\":\"其他\",\"value\":12}]', 1, '001110', 0, 1, 1, 1, '2020-06-03 18:16:25');
INSERT INTO `wk_hrm_employee_field` VALUES (1122, 'contacts_name', '联系人姓名', 1, 0, 1, 7, '', '', 255, '', 0, 1, 1, '', 1, '001110', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1123, 'relation', '关系', 1, 0, 1, 7, '', '', 255, '', 0, 0, 1, '', 1, '001110', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1124, 'contacts_phone', '联系人电话', 7, 0, 1, 7, '', '', 255, '', 0, 0, 1, '', 1, '001110', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1125, 'contacts_work_unit', '联系人工作单位', 1, 0, 1, 7, '', '', 255, '', 0, 0, 1, '', 1, '001110', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1126, 'contacts_post', '联系人职务', 1, 0, 1, 7, '', '', 255, '', 0, 0, 1, '', 1, '001110', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1127, 'contacts_address', '联系人地址', 1, 0, 1, 7, '', '', 255, '', 0, 0, 1, '', 1, '001110', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1128, '手机号码', '手机号码', 7, 0, 1, 2, '', '', 255, '', 0, 0, 1, '', 0, '111111', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1129, 'email', '个人邮箱', 14, 0, 1, 2, '', '', 255, '', 0, 0, 2, '', 1, '000000', 0, 1, 0, 0, '2020-06-03 18:36:39');
INSERT INTO `wk_hrm_employee_field` VALUES (1130, 'QQ', 'QQ', 1, 0, 1, 2, '', '', 255, '', 0, 0, 3, '', 0, '111111', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1131, '微信', '微信', 1, 0, 1, 2, '', '', 255, '', 0, 0, 4, '', 0, '111111', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1132, '现居住地', '现居住地', 1, 0, 1, 2, '', '', 255, '', 0, 0, 5, '', 0, '111111', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1133, '紧急联系人', '紧急联系人', 1, 0, 1, 2, '', '', 255, '', 0, 0, 6, '', 0, '111111', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1134, '紧急联系人电话', '紧急联系人电话', 7, 0, 1, 2, '', '', 255, '', 0, 0, 7, '', 0, '111111', 0, 1, 0, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1135, 'job_number', '工号', 1, 0, 2, 11, '', '', 50, '', 1, 1, 4, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1136, 'entry_time', '入职日期', 4, 0, 2, 11, '', '', 50, '', 0, 1, 1, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1137, 'dept_id', '部门', 3, 2, 2, 11, '', '', 50, '', 0, 0, 5, '', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1138, 'post', '岗位', 1, 0, 2, 11, '', '', 50, '', 0, 0, 7, '', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1139, 'parent_id', '直属上级', 3, 1, 2, 11, '', '', 50, '', 0, 0, 6, '', 1, '000000', 0, 1, 1, 0, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1140, 'post_level', '职级', 1, 0, 2, 11, '', '', 50, '', 0, 0, 8, '', 1, '001110', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1141, 'work_city', '工作城市', 40, 0, 2, 11, '', '', 255, '', 0, 0, 11, '', 1, '000000', 0, 1, 1, 1, '2020-06-03 18:34:29');
INSERT INTO `wk_hrm_employee_field` VALUES (1142, 'work_address', '工作地点', 1, 0, 2, 11, '', '', 255, '', 0, 0, 9, '', 1, '001110', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1143, 'work_detail_address', '详细工作地点', 1, 0, 2, 11, '', '', 255, '', 0, 0, 10, '', 1, '001110', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1144, 'employment_forms', '聘用形式', 3, 0, 2, 11, '', '', 255, '', 0, 1, 13, '[{\"name\":\"正式\",\"value\":1},{\"name\":\"非正式\",\"value\":2}]', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1145, 'probation', '试用期', 3, 0, 2, 11, '', '', 50, '', 0, 0, 2, '[{\"name\":\"无试用期\",\"value\":0},{\"name\":\"1个月\",\"value\":1},{\"name\":\"2个月\",\"value\":2},{\"name\":\"3个月\",\"value\":3},{\"name\":\"4个月\",\"value\":4},{\"name\":\"5个月\",\"value\":5},{\"name\":\"6个月\",\"value\":6}]', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1146, 'become_time', '转正日期', 4, 0, 2, 11, '', '', 50, '', 0, 0, 3, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1147, 'company_age_start_time', '司龄开始日期', 4, 0, 2, 11, '', '', 255, '', 0, 0, 14, '', 1, '000010', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1148, 'company_age', '司龄', 5, 0, 2, 11, '', '', 255, '', 0, 0, 15, '', 1, '000000', 0, 0, 1, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1149, 'channel_id', '招聘渠道', 3, 6, 2, 11, '', '', 255, '', 0, 0, 12, '', 1, '001110', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1150, 'status', '员工状态', 3, 0, 2, 11, '', '', 255, '', 0, 0, 13, '[{\"name\":\"正式\",\"value\":1},{\"name\":\"试用\",\"value\":2},{\"name\":\"实习\",\"value\":3},{\"name\":\"兼职\",\"value\":4},{\"name\":\"劳务\",\"value\":5},{\"name\":\"顾问\",\"value\":6},{\"name\":\"返聘\",\"value\":7},{\"name\":\"外包\",\"value\":8},{\"name\":\"待离职\",\"value\":9},{\"name\":\"已离职\",\"value\":10}]', 1, '000000', 0, 1, 1, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1151, 'contract_type', '合同类型', 3, 0, 3, 21, '', '', 255, '', 0, 0, 1, '[{\"name\":\"固定期限劳动合同\",\"value\":1},{\"name\":\"无固定期限劳动合同\",\"value\":2},{\"name\":\"已完成一定工作任务为期限的劳动合同\",\"value\":3},{\"name\":\"实习协议\",\"value\":4},{\"name\":\"劳务合同\",\"value\":5},{\"name\":\"返聘协议\",\"value\":6},{\"name\":\"劳务派遣合同\",\"value\":7},{\"name\":\"借调合同\",\"value\":8},{\"name\":\"其他\",\"value\":9}]', 1, '000000', 0, 1, 1, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1152, 'start_time', '现合同开始日期', 4, 0, 3, 21, '', '', 255, '', 0, 0, 2, '', 1, '000000', 0, 1, 1, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1153, 'end_time', '现合同结束日期', 4, 0, 3, 21, '', '', 255, '', 0, 0, 3, '', 1, '000000', 0, 1, 1, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1154, 'term', '现合同期限', 5, 0, 3, 21, '', '', 255, '', 0, 0, 4, '', 1, '000000', 0, 1, 1, 0, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1155, 'salary_card_num', '工资卡卡号', 1, 0, 4, 31, '', '', 255, '', 0, 0, 1, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1156, 'account_opening_city', '工资卡开户城市', 1, 0, 4, 31, '', '', 255, '', 0, 0, 2, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1157, 'bank_name', '银行名称', 1, 0, 4, 31, '', '', 255, '', 0, 0, 4, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1158, 'opening_bank', '工资卡开户行', 1, 0, 4, 31, '', '', 255, '', 0, 0, 5, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1159, 'social_security_num', '个人社保账号', 1, 0, 4, 32, '', '', 255, '', 0, 0, 1, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
INSERT INTO `wk_hrm_employee_field` VALUES (1160, 'accumulation_fund_num', '个人公积金账号', 1, 0, 4, 32, '', '', 255, '', 0, 0, 2, '', 1, '000000', 0, 1, 1, 1, '2020-06-02 20:28:49');
...
CREATE TABLE `wk_hrm_employee_field_config`  (
  ...
  `width` int(5) NULL DEFAULT NULL COMMENT '字段宽度',
  `field_id` int(11) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `label`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 345 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字段排序表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_employee_field_config
-- ----------------------------
INSERT INTO `wk_hrm_employee_field_config` VALUES (302, 1, 14773, 0, 100, 1103, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (303, 2, 14773, 0, 100, 1105, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (304, 3, 14773, 0, 100, 1106, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (305, 4, 14773, 0, 100, 1107, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (306, 5, 14773, 0, 100, 1108, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (307, 6, 14773, 0, 100, 1109, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (308, 7, 14773, 0, 100, 1111, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (309, 8, 14773, 0, 100, 1112, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (310, 9, 14773, 0, 100, 1113, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (311, 10, 14773, 0, 100, 1114, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (312, 11, 14773, 0, 100, 1115, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (313, 12, 14773, 0, 100, 1116, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (314, 13, 14773, 0, 100, 1117, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (315, 14, 14773, 0, 100, 1118, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (316, 15, 14773, 0, 100, 1119, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (317, 16, 14773, 0, 100, 1120, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (318, 17, 14773, 0, 100, 1121, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (319, 18, 14773, 0, 100, 1136, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (320, 19, 14773, 0, 100, 1145, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (321, 20, 14773, 0, 100, 1146, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (322, 21, 14773, 0, 100, 1135, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (323, 22, 14773, 0, 100, 1137, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (324, 23, 14773, 0, 100, 1139, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (325, 24, 14773, 0, 100, 1138, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (326, 25, 14773, 0, 100, 1140, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (327, 26, 14773, 0, 100, 1142, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (328, 27, 14773, 0, 100, 1143, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (329, 28, 14773, 0, 100, 1141, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (330, 29, 14773, 0, 100, 1149, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (331, 30, 14773, 0, 100, 1144, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (332, 31, 14773, 0, 100, 1150, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (333, 32, 14773, 0, 100, 1147, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (334, 33, 14773, 0, 100, 1148, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (335, 34, 14773, 0, 100, 1151, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (336, 35, 14773, 0, 100, 1152, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (337, 36, 14773, 0, 100, 1153, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (338, 37, 14773, 0, 100, 1154, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (339, 38, 14773, 0, 100, 1155, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (340, 39, 14773, 0, 100, 1156, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (341, 40, 14773, 0, 100, 1157, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (342, 41, 14773, 0, 100, 1158, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (343, 42, 14773, 0, 100, 1159, '2020-09-07 14:54:42', NULL);
INSERT INTO `wk_hrm_employee_field_config` VALUES (344, 43, 14773, 0, 100, 1160, '2020-09-07 14:54:42', NULL);
...
CREATE TABLE `wk_hrm_employee_file`  (
  `employee_file_id` int(11) NOT NULL AUTO_INCREMENT,
  `employee_id` int(11) NOT NULL COMMENT '员工id',
  `file_id` bigint(20) NOT NULL COMMENT 'admin模块附件id',
  `type` int(4) NULL DEFAULT NULL COMMENT '1 员工基本资料 2 员工档案资料 3 员工离职资料',
  `sub_type` int(4) NOT NULL COMMENT '11、身份证原件 12、学历证明 13、个人证件照 14、身份证复印件 15、工资银行卡 16、社保卡 17、公积金卡 18、获奖证书 19、其他 21、劳动合同 22、入职简历 23、入职登记表 24、入职体检单 25、离职证明 26、转正申请表 27、其他\n31、离职审批 32、离职证明 33 、其他\n',
  `create_user_id` bigint(20) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `wk_hrm_employee_quit_info`  (
  `quit_info_id` int(11) NOT NULL AUTO_INCREMENT,
  `employee_id` int(11) NULL DEFAULT NULL,
  ...
  `quit_type` int(1) NULL DEFAULT NULL COMMENT '离职类型 1 主动离职 2 被动离职 3 退休',
  `quit_reason` int(1) NULL DEFAULT NULL COMMENT '离职原因 1家庭原因 2身体原因 3薪资原因 4交通不便 5工作压力 6管理问题 7无晋升机会 8职业规划 9合同到期放弃续签 10其他个人原因  11试用期内辞退 12违反公司条例 13组织调整/裁员 14绩效不达标辞退 15合同到期不续签 16 其他原因被动离职',
  `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '备注',
  `old_status` int(2) NULL DEFAULT NULL COMMENT '离职前状态',
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`quit_info_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '离职信息' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '员工薪资卡信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_employee_social_security_info`  (
  `social_security_info_id` int(11) NOT NULL AUTO_INCREMENT,
  `employee_id` int(11) NULL DEFAULT NULL,
  `is_first_social_security` int(1) NULL DEFAULT NULL COMMENT '是否首次缴纳社保 0 否 1 是',
  `is_first_accumulation_fund` int(1) NULL DEFAULT NULL COMMENT '是否首次缴纳公积金 0 否 1 是',
  ...
  `scheme_id` int(11) NULL DEFAULT NULL COMMENT '参保方案',
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`social_security_info_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '员工公积金信息' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '培训经历' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '员工工作经历' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_insurance_month_emp_project_record`  (
  ...
  `project_id` int(11) NULL DEFAULT NULL COMMENT '后台配置项目id',
  `type` int(4) NOT NULL COMMENT '1 养老保险基数 2 医疗保险基数 3 失业保险基数 4 工伤保险基数 5 生育保险基数 6 补充大病医疗保险 7 补充养老保险 8 公积金',
...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工每月参保项目表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_insurance_month_emp_record`  (
  `i_emp_record_id` int(11) NOT NULL AUTO_INCREMENT,
  `i_record_id` int(11) NULL DEFAULT NULL COMMENT '每月生成社保id',
  `employee_id` int(11) NULL DEFAULT NULL COMMENT '员工id',
  `scheme_id` int(11) NULL DEFAULT NULL COMMENT '社保方案id',
  ...
  `create_time` datetime(0) NULL DEFAULT NULL,
  `status` int(2) NULL DEFAULT 1 COMMENT '每月社保状态 0 停保 1 正常',
  PRIMARY KEY (`i_emp_record_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工每月社保记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_insurance_month_record`  (
  `i_record_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `num` int(4) NULL DEFAULT NULL COMMENT '参保人数',
  `status` int(2) NULL DEFAULT 0 COMMENT '每月社保状态 0 未归档 1 已归档',
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`i_record_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '每月社保记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_insurance_month_record
-- ----------------------------
INSERT INTO `wk_hrm_insurance_month_record` VALUES (5, '4月社保报表', 2020, 4, 0, 0, '2020-09-07 15:01:56');
...
CREATE TABLE `wk_hrm_insurance_project`  (
  ...
  `type` int(4) NOT NULL COMMENT '1 养老保险基数 2 医疗保险基数 3 失业保险基数 4 工伤保险基数 5 生育保险基数 6 补充大病医疗保险 7 补充养老保险 8 残保险 9 社保自定义 10 公积金 11 公积金自定义',
  `project_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目名称',
  `default_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '默认基数',
  `corporate_proportion` decimal(5, 2) NULL DEFAULT 0.00 COMMENT '公司比例',
  `personal_proportion` decimal(5, 2) NULL DEFAULT 0.00 COMMENT '个人比例',
  `corporate_amount` decimal(10, 2) NOT NULL COMMENT '公司缴纳金额',
  `personal_amount` decimal(10, 2) NOT NULL COMMENT '个人缴纳金额',
  `is_del` int(4) NOT NULL DEFAULT 1 COMMENT '1 删除 0 使用',
...
CREATE TABLE `wk_hrm_insurance_scheme`  (
  ...
  `scheme_type` int(4) NOT NULL COMMENT '参保类型 1 比例 2 金额',
  `is_del` int(4) NOT NULL DEFAULT 0 COMMENT '1 删除 0 使用',
  `create_user_id` bigint(20) NOT NULL COMMENT '创建人id',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
...
-- ----------------------------
INSERT INTO `wk_hrm_insurance_scheme` VALUES (3, '郑州社保方案', '河南省,郑州市,中原区', '社保', 1, 0, 14773, '2020-09-07 15:01:47');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '备忘' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_recruit_candidate`  (
  ...
  `sex` int(4) NOT NULL COMMENT '性别 1男 2女',
  ...
  `work_time` int(2) NULL DEFAULT NULL COMMENT '工作年限',
  `education` int(4) NOT NULL COMMENT '学历 1小学 2初中 3高中 4大专 5本科 6硕士 7博士',
  ...
  `channel_id` int(11) NULL DEFAULT NULL COMMENT '招聘渠道',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `status` int(1) NULL DEFAULT 1 COMMENT '候选人状态 1 新候选人 2初选通过 3安排面试 4面试通过 5已发offer 6待入职 7已淘汰 8已入职',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '招聘候选人表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_recruit_channel`  (
  ...
  `is_sys` int(2) NULL DEFAULT 0 COMMENT '是否系统默认0 否 1 是',
...
CREATE TABLE `wk_hrm_recruit_interview`  (
  ...
  `type` int(4) NULL DEFAULT NULL COMMENT '面试方式 1现场面试 2电话面试 3视频面试',
  `stage_num` int(11) NOT NULL DEFAULT 1 COMMENT '面试轮次',
  `interview_employee_id` int(11) NULL DEFAULT NULL COMMENT '面试官id',
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `result` int(4) NULL DEFAULT 1 COMMENT '面试情况 1面试未完成 2面试通过 3面试未通过 4 面试取消',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '面试表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_recruit_post`  (
  ...
  `dept_id` int(11) NULL DEFAULT NULL COMMENT '部门id',
  `job_nature` int(1) NULL DEFAULT NULL COMMENT '工作性质 1 全职 2实习 3兼职',
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '工作城市',
  `recruit_num` int(4) NULL DEFAULT 0 COMMENT '招聘人数',
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '招聘原因',
  `work_time` int(4) NULL DEFAULT NULL COMMENT '工作经验 1不限 2一年以内 3一至三年 4三至五年 5五至十年 6十年以上',
  `education_require` int(4) NULL DEFAULT NULL COMMENT '学历要求 1不限 2高中及以上 3大专及以上 4本科及以上 5硕士及以上 6博士',
  `min_salary` decimal(10, 2) NULL DEFAULT NULL COMMENT '开始薪资 -1 面议',
  `max_salary` decimal(10, 2) NULL DEFAULT NULL COMMENT '结束薪资 -1 面议',
  `salary_unit` int(2) NULL DEFAULT NULL COMMENT '薪资单位 1 元/年 2 元/月',
  `min_age` int(3) NULL DEFAULT NULL COMMENT '最小年龄 -1 不限',
  `max_age` int(3) NULL DEFAULT NULL COMMENT '最大年龄 -1 不限',
  `latest_entry_time` datetime(0) NULL DEFAULT NULL COMMENT '最迟到岗时间',
  `owner_employee_id` int(11) NULL DEFAULT NULL COMMENT '负责人id',
  ...
  `emergency_level` int(1) NULL DEFAULT NULL COMMENT '紧急程度 1紧急 2 一般',
  `post_type_id` int(11) NULL DEFAULT NULL COMMENT '职位类型',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `create_user_id` bigint(20) NOT NULL COMMENT '创建人id',
  `batch_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '批次id',
  `status` int(4) NULL DEFAULT 1 COMMENT '0 停止  1 启用',
...
CREATE TABLE `wk_hrm_salary_config`  (
  `config_id` int(11) NOT NULL AUTO_INCREMENT,
  `salary_cycle_start_day` int(2) NULL DEFAULT NULL COMMENT '计薪周期开始日',
  `salary_cycle_end_day` int(2) NULL DEFAULT NULL COMMENT '计薪周期结束日',
  `pay_type` int(2) NULL DEFAULT NULL COMMENT '发薪日期类型 1 当月 2 次月',
  `pay_day` int(2) NULL DEFAULT NULL COMMENT '发薪日期',
  `social_security_month_type` int(2) NULL DEFAULT NULL COMMENT '对应社保自然月 0上月 1当月 2次月',
...
-- ----------------------------
INSERT INTO `wk_hrm_salary_config` VALUES (2, NULL, NULL, NULL, NULL, NULL, NULL, '2020-04');
...
CREATE TABLE `wk_hrm_salary_group`  (
  ...
  `rule_id` int(11) NULL DEFAULT NULL COMMENT '计税规则id',
  `create_time` datetime(0) NOT NULL,
  `create_user_id` bigint(20) NOT NULL,
  PRIMARY KEY (`group_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '薪资组' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for wk_hrm_salary_history_data
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_salary_history_data`;
CREATE TABLE `wk_hrm_salary_history_data`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `history_record_id` int(11) NULL DEFAULT NULL,
  `employee_id` int(11) NULL DEFAULT NULL,
  `data` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据(json)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '历史薪资数据记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_salary_history_data
-- ----------------------------

-- ----------------------------
-- Table structure for wk_hrm_salary_history_record
-- ----------------------------
DROP TABLE IF EXISTS `wk_hrm_salary_history_record`;
CREATE TABLE `wk_hrm_salary_history_record`  (
  `history_record_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '历史工资表名称',
  `tax_num` int(4) NULL DEFAULT NULL COMMENT '计薪人数',
  `expected_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '应发工资',
  `actual_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '实发工资',
  `tax_total` decimal(10, 2) NULL DEFAULT NULL COMMENT '个税总额',
  `year` int(4) NULL DEFAULT NULL COMMENT '年',
  `month` int(4) NULL DEFAULT NULL COMMENT '月',
  `title` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '当月工资表头（json数组）',
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`history_record_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_salary_history_record
-- ----------------------------
...
CREATE TABLE `wk_hrm_salary_month_emp_record`  (
  `s_emp_record_id` int(11) NOT NULL AUTO_INCREMENT,
  `s_record_id` int(11) NULL DEFAULT NULL COMMENT '每月生成薪资id',
  `employee_id` int(11) NULL DEFAULT NULL COMMENT '员工id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工每月薪资记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_salary_month_option_value`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `s_emp_record_id` int(20) NULL DEFAULT NULL COMMENT '每月员工薪资记录id',
  `code` int(5) NULL DEFAULT NULL,
  `value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 985 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '每月员工薪资项表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_salary_month_record`  (
  ...
  `check_status` int(2) NULL DEFAULT 5 COMMENT '状态  0待审核、1通过、2拒绝、3审核中 4:撤回 5 未提交  10 历史薪资 11核算完成',
  `create_user_id` bigint(20) NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`s_record_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '每月薪资记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wk_hrm_salary_option`  (
  ...
  `code` int(5) NULL DEFAULT NULL,
  `parent_code` int(5) NULL DEFAULT NULL,
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `is_fixed` int(2) NULL DEFAULT NULL COMMENT '是否固定 0 否 1 是',
  `is_plus` int(2) NULL DEFAULT NULL COMMENT '是否加项 0 减 1 加',
  `is_tax` int(2) NULL DEFAULT NULL COMMENT '是否计税 0 否 1 是',
  `is_show` int(2) NULL DEFAULT NULL COMMENT '是否展示 0 否 1 是',
  `is_compute` int(2) NULL DEFAULT NULL COMMENT '是否参与薪资计算 0 否 1 是',
  `is_open` int(2) NULL DEFAULT NULL,
  PRIMARY KEY (`option_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1227 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统薪资项' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wk_hrm_salary_option
-- ----------------------------
INSERT INTO `wk_hrm_salary_option` VALUES (1161, 10, 0, '基本工资', NULL, 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1162, 10101, 10, '基本工资', '劳动合同中约定的标准工资。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1163, 10102, 10, '岗位工资', '根据岗位、责任、技能要求等，不同岗位，工资不同。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1164, 10103, 10, '职务工资', '根据职务高低、业务技术水平等因素的不同，工资不同，随职务变动而变动。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1165, 20, 0, '津补贴', '企业给员工提供的福利', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1166, 20101, 20, '住房补贴', '为职工解决住房问题而给予的补贴资助。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1167, 20102, 20, '高温津贴', '用人单位安排劳动者在高温天气下工作，当温度高于33℃，应支付高温补贴。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1168, 20103, 20, '交通补贴', '企业按月按标准支付的交通补贴', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1169, 20104, 20, '餐补', '企业不统一供餐，而是按月按标准支付的午饭或晚餐补贴', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1170, 30, 0, '浮动工资', '浮动工资需要在每月算薪前手工录入', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1171, 30101, 30, '绩效工资', '以员工的实际劳动成果或表现为考核标准，支付一定的奖励工资。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1172, 40, 0, '奖金', NULL, 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1173, 40101, 40, '季度奖', '对于表现优秀的员工，按季度给予一定的奖励工资。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1174, 40102, 40, '全勤奖', '对于按公司规定到岗工作，未出现任何迟到、早退的员工给予的奖励，一般以月度为考核期限。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1175, 40103, 40, '推荐奖', '企业在招揽人才的过程中，对推荐人才并顺利入职的内部员工，给予的奖励工资。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1176, 50, 0, '提成工资', NULL, 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1177, 50101, 50, '销售提成', '对于销售或业务人员，通常按照一定的比例，企业和员工之间对盈利进行分成。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1178, 60, 0, '计件工资', NULL, 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1179, 60101, 60, '计件工资', '根据职工完成的劳动数量和按事先规定的计件单价计算和支付的工资。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1180, 70, 0, '计时工资', NULL, 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1181, 70101, 70, '计时工资', '根据职工的工作时间,按照工资标准、等级计算和支付的工资', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1182, 80, 0, '工龄/司龄工资', NULL, 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1183, 80101, 80, '工龄工资', '企业按照员工的工作年数，即员工的工作经验和劳动贡献的积累给予的经济补偿。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1184, 80102, 80, '司龄工资', '司龄工资是按照劳动者在在公司做的时间的长短进行相应工资的计算。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1185, 90, 0, '职称工资', NULL, 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1186, 90101, 90, '职称工资', '工资高低与职称挂钩，职称越高，工资越高。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1187, 90102, 90, '技能工资', '以员工个人所掌握的知识、技术和所具备的能力为基础来进行工资报酬的支付。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1188, 90103, 90, '学历工资', '根据员工在教育机构取得的学历而给予适当的津贴。', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1189, 100, 0, '代扣代缴', '公司代替个人缴纳的费用，如个人社保、个人公积金。该类别下的薪酬项，将从应纳税所得额中扣除，影响个税计算', 0, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1190, 100101, 100, '个人社保', '社保中个人缴纳的部分', 0, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1191, 100102, 100, '个人公积金', '公积金中个人缴纳的部分', 0, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1192, 110, 0, '企业社保', '该类别下的薪酬项，不参与工资计算，只参与企业成本统计或社保成本分析', 0, 1, 0, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1193, 110101, 110, '企业社保', '企业承担的社保费用', 0, 1, 0, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1194, 120, 0, '企业公积金', '该类别下的薪酬项，不参与工资计算，只参与企业成本统计或社保成本分析', 0, 1, 0, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1195, 120101, 120, '企业公积金', '企业承担的公积金费用', 0, 1, 0, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1196, 130, 0, '税前补发', '税前补发，与该月的工资一起发放，需参与计税', 0, 1, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1197, 130101, 130, '税前补发', '如上月漏发，这月补发的工资', 0, 1, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1198, 140, 0, '税前补扣', '税前从该月的工资中补扣的金额，会影响本月的应税工资总额', 0, 0, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1199, 140101, 140, '税前补扣', '如上月未扣，这月补扣的扣款；', 0, 0, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1200, 150, 0, '税后补发', '税后补发，不参与该月工资计算，会影响当月的实际所得', 0, 1, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1201, 150101, 150, '税后补发', '其它税后补发', 0, 1, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1202, 160, 0, '税后补扣', '从税后的工资中补扣的款项，不参与该月的工资计税', 0, 0, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1203, 160101, 160, '党费', '向党组织交纳的用于党的事业和党的活动的经费，由公司代收。', 0, 0, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1204, 160102, 160, '工会费', '员工缴纳的，工会组织开展各项活动所需要的费用', 0, 0, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1205, 160103, 160, '补充医疗', '企业在基本医疗保险的基础上，为员工缴纳的额外补充医疗保险。', 0, 0, 0, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1206, 170, 0, '特殊计税项', '其它里的科目不参与工资计算，但要计税', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1207, 170101, 170, '商业保险金', '商业保险金不参与计算，但要计税', 0, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1208, 180, 0, '加班工资', '公司按员工加班时长计算的加班报酬', 1, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1209, 180101, 180, '加班工资', '按一定的比例，按加班时长计算加班工资', 1, 1, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1210, 190, 0, '考勤扣款明细', NULL, 1, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1211, 190101, 190, '迟到扣款', '员工无故迟到，需扣除一定的工资作为惩戒', 1, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1212, 190102, 190, '早退扣款', '员工无故早退，需扣除一定的工资作为惩戒', 1, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1213, 190103, 190, '旷工扣款', '员工无故旷工，需扣除一定的工资作为惩戒', 1, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1214, 190104, 190, '假期扣款', '员工因请事假、病假等，工作日未能到岗，需扣除一定的工资', 1, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1215, 190105, 190, '缺卡扣款', '员工无故缺卡，需扣除一定的金额作为惩戒', 1, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1216, 190106, 190, '综合扣款', '按月累计迟到和早退时长或次数，计算的考勤扣款金额', 1, 0, 1, 1, 1, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1217, 200, 0, '考勤扣款合计', NULL, 1, 0, 1, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1218, 200101, 200, '考勤扣款合计', '迟到、早退、旷工、缺卡、请假等6中异常考勤的扣款合计', 1, 0, 1, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1219, 210, 0, '应发工资', NULL, 1, 2, 2, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1220, 210101, 210, '应发工资', '应发工资=员工工资总额-请假扣款-考勤扣款等', 1, 2, 2, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1221, 220, 0, '应税工资', NULL, 1, 2, 2, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1222, 220101, 220, '应税工资', '应税工资=应发工资-个人社保-个人公积金-每月减除费用', 1, 2, 2, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1223, 230, 0, '个人所得税', NULL, 1, 2, 2, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1224, 230101, 230, '个人所得税', '根据个税计算规则，计算的每月应缴纳个税', 1, 2, 2, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1225, 240, 0, '实发工资', NULL, 1, 2, 2, 1, 0, 1);
INSERT INTO `wk_hrm_salary_option` VALUES (1226, 240101, 240, '实发工资', '员工每月获得的实际收入。', 1, 2, 2, 1, 0, 1);
...
CREATE TABLE `wk_hrm_salary_option_template`  (
  ...
  `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `is_fixed` int(2) NULL DEFAULT NULL COMMENT '是否固定 0 否 1 是',
  `is_plus` int(2) NULL DEFAULT NULL COMMENT '是否加项 0 减 1 加 2 计算所得',
  `is_tax` int(2) NULL DEFAULT NULL COMMENT '是否计税 0 否 1 是',
  `is_show` int(2) NULL DEFAULT NULL COMMENT '是否展示 0 否 1 是',
  `is_compute` int(2) NULL DEFAULT NULL COMMENT '是否参与薪资计算 0 否 1 是',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wk_hrm_salary_tax_rule`  (
  ...
  `tax_type` int(2) NULL DEFAULT NULL COMMENT '个税类型 1 工资薪金所得税 2 劳务报酬所得税 3 不计税',
  `is_tax` int(2) NULL DEFAULT NULL COMMENT '是否计税 0 否 1 是',
  `marking_point` int(5) NULL DEFAULT NULL COMMENT '起征点',
  `decimal_point` int(2) NULL DEFAULT NULL COMMENT '个税结果(保留小数点)',
  `cycle_type` int(2) NULL DEFAULT NULL COMMENT '计税周期类型 1 上年12月到今年11月（对应的工资发放方式为次月发上月工资） 2 今年1月到12月（对应的工资发放方式为当月发当月工资）',
